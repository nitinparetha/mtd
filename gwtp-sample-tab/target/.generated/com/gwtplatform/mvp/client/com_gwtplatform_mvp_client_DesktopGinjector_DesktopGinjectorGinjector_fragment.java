...
public class com_gwtplatform_mvp_client_DesktopGinjector_DesktopGinjectorGinjector_fragment {
  ...
  public void memberInject_Key$type$com$gwtplatform$mvp$client$RootPresenter$_annotation$$none$$(com.gwtplatform.mvp.client.RootPresenter injectee) {
    com$gwtplatform$mvp$client$HandlerContainerImpl_automaticBind_methodInjection____________(injectee, get_Key$type$com$gwtplatform$mvp$client$AutobindDisable$_annotation$$none$$());
   ...
   *   com.gwtplatform.samples.tab.client.gin.ClientModule.configure(ClientModule.java:42)
   */
  public java.lang.String get_Key$type$java$lang$String$_annotation$$com$gwtplatform$mvp$client$annotations$DefaultPlace$() {
    java.lang.String result = "!homeNewsPage";
    return result;
  ...
  /**
   * Binding for java.lang.String declared at:
   *   com.gwtplatform.samples.tab.client.gin.ClientModule.configure(ClientModule.java:43)
   */
  ...
  /**
   * Binding for java.lang.String declared at:
   *   com.gwtplatform.samples.tab.client.gin.ClientModule.configure(ClientModule.java:44)
   */
