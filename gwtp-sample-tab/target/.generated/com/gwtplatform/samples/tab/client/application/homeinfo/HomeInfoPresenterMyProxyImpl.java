...
public class HomeInfoPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.TabContentProxyPlaceImpl<HomeInfoPresenter> implements com.gwtplatform.samples.tab.client.application.homeinfo.HomeInfoPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gwtplatform.mvp.client.ClientGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.NonLeafTabContentProxyImpl<HomeInfoPresenter> implements com.gwtplatform.mvp.client.DelayedBind {
    ...
    public void delayedBind(Ginjector baseGinjector) {
      ...
      targetHistoryToken = "!homeInfoPage";
      addRequestTabsHandler();
      presenter = new CodeSplitProvider<HomeInfoPresenter>( ginjector.getcomgwtplatformsamplestabclientapplicationhomeinfoHomeInfoPresenter() );
    }
    
    protected TabData getTabDataInternal(com.gwtplatform.mvp.client.ClientGinjector ginjector) {
      return new TabDataBasic("Info", 1);
    }
  }
  
  public HomeInfoPresenterMyProxyImpl() {
