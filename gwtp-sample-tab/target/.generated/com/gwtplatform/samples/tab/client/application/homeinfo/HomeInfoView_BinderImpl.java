// .ui.xml template last modified: 1422228557504
...
public class HomeInfoView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.gwtplatform.samples.tab.client.application.homeinfo.HomeInfoView>, com.gwtplatform.samples.tab.client.application.homeinfo.HomeInfoView.Binder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.gwtplatform.samples.tab.client.application.homeinfo.HomeInfoView owner) {
   ...
   */
  class Widgets {
    private final com.gwtplatform.samples.tab.client.application.homeinfo.HomeInfoView owner;


    public Widgets(final com.gwtplatform.samples.tab.client.application.homeinfo.HomeInfoView owner) {
      this.owner = owner;
    }
     ...
     */
    private com.gwtplatform.samples.tab.client.application.homeinfo.HomeInfoView_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.gwtplatform.samples.tab.client.application.homeinfo.HomeInfoView_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.gwtplatform.samples.tab.client.application.homeinfo.HomeInfoView_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.gwtplatform.samples.tab.client.application.homeinfo.HomeInfoView_BinderImpl_GenBundle) GWT.create(com.gwtplatform.samples.tab.client.application.homeinfo.HomeInfoView_BinderImpl_GenBundle.class);
      // Setup section.
