// .ui.xml template last modified: 1422228557196
...
public class LinkMenu_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.gwtplatform.samples.tab.client.application.ui.linkmenu.LinkMenu>, com.gwtplatform.samples.tab.client.application.ui.linkmenu.LinkMenu.Binder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.gwtplatform.samples.tab.client.application.ui.linkmenu.LinkMenu owner) {
   ...
   */
  class Widgets {
    private final com.gwtplatform.samples.tab.client.application.ui.linkmenu.LinkMenu owner;


    public Widgets(final com.gwtplatform.samples.tab.client.application.ui.linkmenu.LinkMenu owner) {
      this.owner = owner;
     ...
     */
    private com.gwtplatform.samples.tab.client.application.ui.linkmenu.LinkMenu_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.gwtplatform.samples.tab.client.application.ui.linkmenu.LinkMenu_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.gwtplatform.samples.tab.client.application.ui.linkmenu.LinkMenu_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.gwtplatform.samples.tab.client.application.ui.linkmenu.LinkMenu_BinderImpl_GenBundle) GWT.create(com.gwtplatform.samples.tab.client.application.ui.linkmenu.LinkMenu_BinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private com.gwtplatform.samples.tab.client.place.NameTokens nameTokens;
    ...
    private com.gwtplatform.samples.tab.client.place.NameTokens build_nameTokens() {
      // Creation section.
      nameTokens = (com.gwtplatform.samples.tab.client.place.NameTokens) GWT.create(com.gwtplatform.samples.tab.client.place.NameTokens.class);
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.InlineHyperlink build_f_InlineHyperlink2() {
      ...
      f_InlineHyperlink2.setTargetHistoryToken("" + get_nameTokens().getHomeNewsPage() + "");
    ...
    private com.google.gwt.user.client.ui.InlineHyperlink build_f_InlineHyperlink3() {
      ...
      f_InlineHyperlink3.setTargetHistoryToken("" + get_nameTokens().getLocalDialogSamplePage() + "");
    ...
    private com.google.gwt.user.client.ui.InlineHyperlink build_f_InlineHyperlink4() {
      ...
      f_InlineHyperlink4.setTargetHistoryToken("" + get_nameTokens().getSettingsPage() + "");
