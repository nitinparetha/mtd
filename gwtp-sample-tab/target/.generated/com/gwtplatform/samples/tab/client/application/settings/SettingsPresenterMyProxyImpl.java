...
public class SettingsPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.TabContentProxyPlaceImpl<SettingsPresenter> implements com.gwtplatform.samples.tab.client.application.settings.SettingsPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gwtplatform.mvp.client.ClientGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.NonLeafTabContentProxyImpl<SettingsPresenter> implements com.gwtplatform.mvp.client.DelayedBind {
    ...
    public void delayedBind(Ginjector baseGinjector) {
      ...
      targetHistoryToken = "!settingsPage";
      addRequestTabsHandler();
      presenter = new CodeSplitProvider<SettingsPresenter>( ginjector.getcomgwtplatformsamplestabclientapplicationsettingsSettingsPresenter() );
    }
    
    protected TabData getTabDataInternal(com.gwtplatform.mvp.client.ClientGinjector ginjector) {
      return new TabDataBasic("Settings", 2);
    }
  }
  
  public SettingsPresenterMyProxyImpl() {
