// .ui.xml template last modified: 1422228556826
...
public class LocalDialogSubTabView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.gwtplatform.samples.tab.client.application.localdialog.LocalDialogSubTabView>, com.gwtplatform.samples.tab.client.application.localdialog.LocalDialogSubTabView.Binder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.gwtplatform.samples.tab.client.application.localdialog.LocalDialogSubTabView owner) {
   ...
   */
  class Widgets {
    private final com.gwtplatform.samples.tab.client.application.localdialog.LocalDialogSubTabView owner;


    final com.google.gwt.event.dom.client.ClickHandler handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1 = new com.google.gwt.event.dom.client.ClickHandler() {
      public void onClick(com.google.gwt.event.dom.client.ClickEvent event) {
        owner.onLocalClicked((com.google.gwt.event.dom.client.ClickEvent) event);
      }
    };

    public Widgets(final com.gwtplatform.samples.tab.client.application.localdialog.LocalDialogSubTabView owner) {
      this.owner = owner;
     ...
     */
    private com.gwtplatform.samples.tab.client.application.localdialog.LocalDialogSubTabView_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.gwtplatform.samples.tab.client.application.localdialog.LocalDialogSubTabView_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.gwtplatform.samples.tab.client.application.localdialog.LocalDialogSubTabView_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.gwtplatform.samples.tab.client.application.localdialog.LocalDialogSubTabView_BinderImpl_GenBundle) GWT.create(com.gwtplatform.samples.tab.client.application.localdialog.LocalDialogSubTabView_BinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private com.gwtplatform.samples.tab.client.application.localdialog.LocalDialogSubTabView_BinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private com.gwtplatform.samples.tab.client.application.localdialog.LocalDialogSubTabView_BinderImpl_GenCss_style build_style() {
      // Creation section.
      final com.gwtplatform.samples.tab.client.application.localdialog.LocalDialogSubTabView_BinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      f_HTMLPanel1.addAndReplaceElement(get_localDialog(), get_domId0Element().get());
    ...
    /**
     * Getter for localDialog called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private com.google.gwt.user.client.ui.Button get_localDialog() {
      return build_localDialog();
    }
    private com.google.gwt.user.client.ui.Button build_localDialog() {
      // Creation section.
      final com.google.gwt.user.client.ui.Button localDialog = (com.google.gwt.user.client.ui.Button) GWT.create(com.google.gwt.user.client.ui.Button.class);
      // Setup section.
      localDialog.setHTML(template_html1().asString());
      localDialog.addClickHandler(handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1);

      this.owner.localDialog = localDialog;
