...
package com.seimens.plm.tcmfg.client.application.ui.linkmenu;
 ...
 * requires a method returning {@link LinkMenu} in {@link com.gwtplatform.samples.tab.client.gin.ClientGinjector
 * ClientGinjector}. Finally, it is good practice to bind the {@link LinkMenu.Binder} interface as a singleton, which is
 * done in {@link UiModule}.
 */
