...
public class com_gwtplatform_mvp_client_DesktopGinjector_DesktopGinjectorGinjector_fragment {
   ...
   *   com.gwtplatform.samples.basicspring.client.gin.ClientModule.configure(ClientModule.java:39)
   */
  ...
  /**
   * Binding for java.lang.String declared at:
   *   com.gwtplatform.samples.basicspring.client.gin.ClientModule.configure(ClientModule.java:40)
   */
  ...
  /**
   * Binding for java.lang.String declared at:
   *   com.gwtplatform.samples.basicspring.client.gin.ClientModule.configure(ClientModule.java:41)
   */
