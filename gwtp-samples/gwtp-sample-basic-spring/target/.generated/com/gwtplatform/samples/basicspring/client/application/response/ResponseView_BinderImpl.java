...
public class ResponseView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.gwtplatform.samples.basicspring.client.application.response.ResponseView>, com.gwtplatform.samples.basicspring.client.application.response.ResponseView.Binder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.gwtplatform.samples.basicspring.client.application.response.ResponseView owner) {
   ...
   */
  class Widgets {
    private final com.gwtplatform.samples.basicspring.client.application.response.ResponseView owner;


    final com.google.gwt.event.dom.client.ClickHandler handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1 = new com.google.gwt.event.dom.client.ClickHandler() {
      public void onClick(com.google.gwt.event.dom.client.ClickEvent event) {
        owner.onClose((com.google.gwt.event.dom.client.ClickEvent) event);
      }
    };

    public Widgets(final com.gwtplatform.samples.basicspring.client.application.response.ResponseView owner) {
      this.owner = owner;
     ...
     */
    private com.gwtplatform.samples.basicspring.client.application.response.ResponseView_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.gwtplatform.samples.basicspring.client.application.response.ResponseView_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.gwtplatform.samples.basicspring.client.application.response.ResponseView_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.gwtplatform.samples.basicspring.client.application.response.ResponseView_BinderImpl_GenBundle) GWT.create(com.gwtplatform.samples.basicspring.client.application.response.ResponseView_BinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private com.gwtplatform.samples.basicspring.client.application.response.ResponseView_BinderImpl_GenCss_style style;
    private com.gwtplatform.samples.basicspring.client.application.response.ResponseView_BinderImpl_GenCss_style get_style() {
      return style;
    }
    private com.gwtplatform.samples.basicspring.client.application.response.ResponseView_BinderImpl_GenCss_style build_style() {
      // Creation section.
    ...
    private com.google.gwt.user.client.ui.HTML build_textToServer() {
      ...
      this.owner.textToServer = textToServer;
    ...
    private com.google.gwt.user.client.ui.HTML build_serverResponse() {
      ...
      this.owner.serverResponse = serverResponse;
