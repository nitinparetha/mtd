...
public class com_gwtplatform_mvp_client_DesktopGinjector_DesktopGinjectorGinjector_fragment {
   ...
   *   com.gwtplatform.samples.mobile.client.gin.SharedModule.configure(SharedModule.java:33)
   */
  ...
  /**
   * Binding for java.lang.String declared at:
   *   com.gwtplatform.samples.mobile.client.gin.SharedModule.configure(SharedModule.java:34)
   */
  ...
  /**
   * Binding for java.lang.String declared at:
   *   com.gwtplatform.samples.mobile.client.gin.SharedModule.configure(SharedModule.java:35)
   */
