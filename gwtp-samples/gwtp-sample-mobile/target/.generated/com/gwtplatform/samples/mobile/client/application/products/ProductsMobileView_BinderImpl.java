// .ui.xml template last modified: 1422228252774
...
public class ProductsMobileView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.gwtplatform.samples.mobile.client.application.products.ProductsMobileView>, com.gwtplatform.samples.mobile.client.application.products.ProductsMobileView.Binder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.gwtplatform.samples.mobile.client.application.products.ProductsMobileView owner) {
   ...
   */
  class Widgets {
    private final com.gwtplatform.samples.mobile.client.application.products.ProductsMobileView owner;


    public Widgets(final com.gwtplatform.samples.mobile.client.application.products.ProductsMobileView owner) {
      this.owner = owner;
     ...
     */
    private com.gwtplatform.samples.mobile.client.application.products.ProductsMobileView_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.gwtplatform.samples.mobile.client.application.products.ProductsMobileView_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.gwtplatform.samples.mobile.client.application.products.ProductsMobileView_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.gwtplatform.samples.mobile.client.application.products.ProductsMobileView_BinderImpl_GenBundle) GWT.create(com.gwtplatform.samples.mobile.client.application.products.ProductsMobileView_BinderImpl_GenBundle.class);
      // Setup section.
