// .ui.xml template last modified: 1422228253134
...
public class ProductTabletView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.gwtplatform.samples.mobile.client.application.product.ProductTabletView>, com.gwtplatform.samples.mobile.client.application.product.ProductTabletView.Binder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.gwtplatform.samples.mobile.client.application.product.ProductTabletView owner) {
   ...
   */
  class Widgets {
    private final com.gwtplatform.samples.mobile.client.application.product.ProductTabletView owner;


    public Widgets(final com.gwtplatform.samples.mobile.client.application.product.ProductTabletView owner) {
      this.owner = owner;
     ...
     */
    private com.gwtplatform.samples.mobile.client.application.product.ProductTabletView_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.gwtplatform.samples.mobile.client.application.product.ProductTabletView_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.gwtplatform.samples.mobile.client.application.product.ProductTabletView_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.gwtplatform.samples.mobile.client.application.product.ProductTabletView_BinderImpl_GenBundle) GWT.create(com.gwtplatform.samples.mobile.client.application.product.ProductTabletView_BinderImpl_GenBundle.class);
      // Setup section.
