...
public class com_gwtplatform_mvp_client_DesktopGinjector_DesktopGinjectorGinjector_fragment {
  ...
  public void memberInject_Key$type$com$gwtplatform$samples$mobile$client$application$product$ProductView$Binder$_annotation$$none$$(com.gwtplatform.samples.mobile.client.application.product.ProductView.Binder injectee) {
    
  }
  
  public void memberInject_Key$type$com$gwtplatform$samples$mobile$client$application$product$ProductView$_annotation$$none$$(com.gwtplatform.samples.mobile.client.application.product.ProductView injectee) {
  ...
  public com.gwtplatform.samples.mobile.client.application.product.ProductPresenter.MyView get_Key$type$com$gwtplatform$samples$mobile$client$application$product$ProductPresenter$MyView$_annotation$$none$$() {
    com.gwtplatform.samples.mobile.client.application.product.ProductPresenter.MyView result = get_Key$type$com$gwtplatform$samples$mobile$client$application$product$ProductView$_annotation$$none$$();
    return result;
  ...
  /**
   * Binding for com.gwtplatform.samples.mobile.client.application.product.ProductView$Binder declared at:
   *   Implicit GWT.create binding for com.gwtplatform.samples.mobile.client.application.product.ProductView$Binder
   */
  public com.gwtplatform.samples.mobile.client.application.product.ProductView.Binder get_Key$type$com$gwtplatform$samples$mobile$client$application$product$ProductView$Binder$_annotation$$none$$() {
    Object created = GWT.create(com.gwtplatform.samples.mobile.client.application.product.ProductView.Binder.class);
    assert created instanceof com.gwtplatform.samples.mobile.client.application.product.ProductView.Binder;
    com.gwtplatform.samples.mobile.client.application.product.ProductView.Binder result = (com.gwtplatform.samples.mobile.client.application.product.ProductView.Binder) created;
    
    memberInject_Key$type$com$gwtplatform$samples$mobile$client$application$product$ProductView$Binder$_annotation$$none$$(result);
    
    return result;
    
  }
  
  private com.gwtplatform.samples.mobile.client.application.product.ProductView singleton_Key$type$com$gwtplatform$samples$mobile$client$application$product$ProductView$_annotation$$none$$ = null;
  
  public com.gwtplatform.samples.mobile.client.application.product.ProductView get_Key$type$com$gwtplatform$samples$mobile$client$application$product$ProductView$_annotation$$none$$() {
    
    if (singleton_Key$type$com$gwtplatform$samples$mobile$client$application$product$ProductView$_annotation$$none$$ == null) {
    com.gwtplatform.samples.mobile.client.application.product.ProductView result = com$gwtplatform$samples$mobile$client$application$product$ProductView_com$gwtplatform$samples$mobile$client$application$product$ProductView_methodInjection(get_Key$type$com$gwtplatform$samples$mobile$client$application$product$ProductView$Binder$_annotation$$none$$());
    memberInject_Key$type$com$gwtplatform$samples$mobile$client$application$product$ProductView$_annotation$$none$$(result);
    
        singleton_Key$type$com$gwtplatform$samples$mobile$client$application$product$ProductView$_annotation$$none$$ = result;
    }
    return singleton_Key$type$com$gwtplatform$samples$mobile$client$application$product$ProductView$_annotation$$none$$;
    
  }
  
  public com.gwtplatform.samples.mobile.client.application.product.ProductView com$gwtplatform$samples$mobile$client$application$product$ProductView_com$gwtplatform$samples$mobile$client$application$product$ProductView_methodInjection(com.gwtplatform.samples.mobile.client.application.product.ProductView.Binder _0) {
    return new com.gwtplatform.samples.mobile.client.application.product.ProductView(_0);
  }
