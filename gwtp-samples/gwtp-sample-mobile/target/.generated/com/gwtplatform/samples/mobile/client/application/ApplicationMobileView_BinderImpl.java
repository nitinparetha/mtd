// .ui.xml template last modified: 1422228253544
...
public class ApplicationMobileView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.gwtplatform.samples.mobile.client.application.ApplicationMobileView>, com.gwtplatform.samples.mobile.client.application.ApplicationMobileView.Binder {
  ...
  interface Template extends SafeHtmlTemplates {
    ...
    @Template("<div class='{0}'> GWTP Mobile Sample <br> <a href='https://github.com/ArcBees/GWTP'>Project Home</a> <br> <a href='https://github.com/ArcBees/GWTP-Samples/tree/master/gwtp-samples/gwtp-sample-hplace'>Source</a> </div> <h1>Choose one of the following... Mobile View</h1> <span id='{1}'></span> <span id='{2}'></span> <span id='{3}'></span>")
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.gwtplatform.samples.mobile.client.application.ApplicationMobileView owner) {
   ...
   */
  class Widgets {
    private final com.gwtplatform.samples.mobile.client.application.ApplicationMobileView owner;
    ...
    public Widgets(final com.gwtplatform.samples.mobile.client.application.ApplicationMobileView owner) {
      this.owner = owner;
     ...
     */
    private com.gwtplatform.samples.mobile.client.application.ApplicationMobileView_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.gwtplatform.samples.mobile.client.application.ApplicationMobileView_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.gwtplatform.samples.mobile.client.application.ApplicationMobileView_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.gwtplatform.samples.mobile.client.application.ApplicationMobileView_BinderImpl_GenBundle) GWT.create(com.gwtplatform.samples.mobile.client.application.ApplicationMobileView_BinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private com.gwtplatform.samples.mobile.client.application.ApplicationMobileView_BinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private com.gwtplatform.samples.mobile.client.application.ApplicationMobileView_BinderImpl_GenCss_style build_style() {
      // Creation section.
      final com.gwtplatform.samples.mobile.client.application.ApplicationMobileView_BinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
