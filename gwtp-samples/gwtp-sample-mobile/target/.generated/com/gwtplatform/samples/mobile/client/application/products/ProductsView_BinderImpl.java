// .ui.xml template last modified: 1422228253582
...
public class ProductsView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.gwtplatform.samples.mobile.client.application.products.ProductsView>, com.gwtplatform.samples.mobile.client.application.products.ProductsView.Binder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.gwtplatform.samples.mobile.client.application.products.ProductsView owner) {
   ...
   */
  class Widgets {
    private final com.gwtplatform.samples.mobile.client.application.products.ProductsView owner;


    public Widgets(final com.gwtplatform.samples.mobile.client.application.products.ProductsView owner) {
      this.owner = owner;
     ...
     */
    private com.gwtplatform.samples.mobile.client.application.products.ProductsView_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.gwtplatform.samples.mobile.client.application.products.ProductsView_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.gwtplatform.samples.mobile.client.application.products.ProductsView_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.gwtplatform.samples.mobile.client.application.products.ProductsView_BinderImpl_GenBundle) GWT.create(com.gwtplatform.samples.mobile.client.application.products.ProductsView_BinderImpl_GenBundle.class);
      // Setup section.
