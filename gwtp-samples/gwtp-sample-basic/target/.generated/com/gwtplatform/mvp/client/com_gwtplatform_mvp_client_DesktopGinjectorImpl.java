...
public class com_gwtplatform_mvp_client_DesktopGinjectorImpl implements com.gwtplatform.mvp.client.DesktopGinjector {
  ...
  public javax.inject.Provider<com.gwtplatform.samples.basic.client.application.ApplicationPresenter> getcomgwtplatformsamplesbasicclientapplicationApplicationPresenter() {
    return fieldcom_gwtplatform_mvp_client_DesktopGinjector_DesktopGinjectorGinjector.getFragment_com_gwtplatform_samples_basic_client_application().get_Key$type$com$google$inject$Provider$com$gwtplatform$samples$basic$client$application$ApplicationPresenter$$_annotation$$none$$();
  }
  ...
  public com.google.gwt.inject.client.AsyncProvider<com.gwtplatform.samples.basic.client.application.response.ResponsePresenter> getcomgwtplatformsamplesbasicclientapplicationresponseResponsePresenter() {
    return fieldcom_gwtplatform_mvp_client_DesktopGinjector_DesktopGinjectorGinjector.getFragment_com_gwtplatform_samples_basic_client_application_response().get_Key$type$com$google$gwt$inject$client$AsyncProvider$com$gwtplatform$samples$basic$client$application$response$ResponsePresenter$$_annotation$$none$$();
  }
