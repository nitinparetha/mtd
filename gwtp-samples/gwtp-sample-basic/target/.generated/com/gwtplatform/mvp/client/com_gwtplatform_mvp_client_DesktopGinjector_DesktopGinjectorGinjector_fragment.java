...
public class com_gwtplatform_mvp_client_DesktopGinjector_DesktopGinjectorGinjector_fragment {
   ...
   *   com.gwtplatform.samples.basic.client.gin.ClientModule.configure(ClientModule.java:38)
   */
  ...
  /**
   * Binding for java.lang.String declared at:
   *   com.gwtplatform.samples.basic.client.gin.ClientModule.configure(ClientModule.java:39)
   */
  ...
  /**
   * Binding for java.lang.String declared at:
   *   com.gwtplatform.samples.basic.client.gin.ClientModule.configure(ClientModule.java:40)
   */
