...
public class com_gwtplatform_mvp_client_DesktopGinjector_DesktopGinjectorGinjector_fragment {
  ...
  public com.gwtplatform.samples.basic.client.application.response.ResponsePresenter get_Key$type$com$gwtplatform$samples$basic$client$application$response$ResponsePresenter$_annotation$$none$$() {
    ...
    com.gwtplatform.samples.basic.client.application.response.ResponsePresenter result = com$gwtplatform$samples$basic$client$application$response$ResponsePresenter_com$gwtplatform$samples$basic$client$application$response$ResponsePresenter_methodInjection(injector.getFragment_com_google_web_bindery_event_shared().get_Key$type$com$google$web$bindery$event$shared$EventBus$_annotation$$none$$(), get_Key$type$com$gwtplatform$samples$basic$client$application$response$ResponsePresenter$MyView$_annotation$$none$$(), get_Key$type$com$gwtplatform$samples$basic$client$application$response$ResponsePresenter$MyProxy$_annotation$$none$$(), injector.getFragment_com_gwtplatform_mvp_client_proxy().get_Key$type$com$gwtplatform$mvp$client$proxy$PlaceManager$_annotation$$none$$(), injector.getFragment_com_gwtplatform_dispatch_rpc_shared().get_Key$type$com$gwtplatform$dispatch$rpc$shared$DispatchAsync$_annotation$$none$$());
  ...
  public com.gwtplatform.samples.basic.client.application.response.ResponsePresenter com$gwtplatform$samples$basic$client$application$response$ResponsePresenter_com$gwtplatform$samples$basic$client$application$response$ResponsePresenter_methodInjection(com.google.web.bindery.event.shared.EventBus _0, com.gwtplatform.samples.basic.client.application.response.ResponsePresenter.MyView _1, com.gwtplatform.samples.basic.client.application.response.ResponsePresenter.MyProxy _2, com.gwtplatform.mvp.client.proxy.PlaceManager _3, com.gwtplatform.dispatch.rpc.shared.DispatchAsync _4) {
    return new com.gwtplatform.samples.basic.client.application.response.ResponsePresenter(_0, _1, _2, _3, _4);
  }
