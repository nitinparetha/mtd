// .ui.xml template last modified: 1422228452009
...
public class AboutUsView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.gwtplatform.samples.nested.client.application.aboutus.AboutUsView>, com.gwtplatform.samples.nested.client.application.aboutus.AboutUsView.Binder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.gwtplatform.samples.nested.client.application.aboutus.AboutUsView owner) {
   ...
   */
  class Widgets {
    private final com.gwtplatform.samples.nested.client.application.aboutus.AboutUsView owner;


    public Widgets(final com.gwtplatform.samples.nested.client.application.aboutus.AboutUsView owner) {
      this.owner = owner;
    }
     ...
     */
    private com.gwtplatform.samples.nested.client.application.aboutus.AboutUsView_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.gwtplatform.samples.nested.client.application.aboutus.AboutUsView_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.gwtplatform.samples.nested.client.application.aboutus.AboutUsView_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.gwtplatform.samples.nested.client.application.aboutus.AboutUsView_BinderImpl_GenBundle) GWT.create(com.gwtplatform.samples.nested.client.application.aboutus.AboutUsView_BinderImpl_GenBundle.class);
      // Setup section.
