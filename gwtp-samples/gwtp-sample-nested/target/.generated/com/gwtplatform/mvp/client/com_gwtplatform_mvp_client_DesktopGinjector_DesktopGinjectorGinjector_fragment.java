...
public class com_gwtplatform_mvp_client_DesktopGinjector_DesktopGinjectorGinjector_fragment {
   ...
   *   com.gwtplatform.samples.nested.client.gin.ClientModule.configure(ClientModule.java:35)
   */
  public java.lang.String get_Key$type$java$lang$String$_annotation$$com$gwtplatform$mvp$client$annotations$DefaultPlace$() {
    java.lang.String result = "!homePage";
    return result;
  ...
  /**
   * Binding for java.lang.String declared at:
   *   com.gwtplatform.samples.nested.client.gin.ClientModule.configure(ClientModule.java:36)
   */
  ...
  /**
   * Binding for java.lang.String declared at:
   *   com.gwtplatform.samples.nested.client.gin.ClientModule.configure(ClientModule.java:37)
   */
